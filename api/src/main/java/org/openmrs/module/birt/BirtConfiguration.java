...
public class BirtConfiguration {
	...
	/*
	 * Required BIRT module properties. Names correspond to global properties in
	 * the database
	 */
	...
	public static Boolean ALWAYS_USE_OPENMRS_JDBC_PROPERTIES = getBooleanGlobalProperty(
			PROPERTY_ALWAYS_USE_OPENMRS_JDBC_PROPERTIES, "false");
	...
	/*
	 * TODO These values do not seem to be working for generated images
	 * (graphs/charts)
	 */
	 ...
	 * 
	 * @return public static IRenderOption getRenderOption() { return
	 *         getRenderOption(REPORT_OUTPUT_FILE, REPORT_OUTPUT_FORMAT); }
	 */

	/**
	 * 
	 * @param outputFormat
	 * @return public static IRenderOption getRenderOption(String format) {
	 *         return getRenderOption(REPORT_OUTPUT_FILE, format); }
	 */

	/**
	 * Creates a render option with the specified output file and format
	 * options.
	 * 
	 * @return
	 */
	...
	/*
	 * TODO Add support for PDF/HTML public static IRenderOption
	 * getPdfRenderOption(String outputFile) { // replace outputFile extension
	 * return getRenderOption(outputFile, "pdf"); }
	 * 
	 * /* TODO Add support for Html public static IRenderOption
	 * getHtmlRenderOption(String outputFile) { // replace outFile extension
	 ...
	 * 
	 * HashMap<String, RenderContext> contextMap = new HashMap<String,
	 * RenderContext>(); HTMLRenderContext renderContext = new
	 * HTMLRenderContext();
	 * 
	 ...
	 * renderContext ); return contextMap; }
	 */
	...
	/**
	 * Convenience method to retrieve boolean value for the specified global
	 * property.
	 * 
	 * @param property
	 *            the property name

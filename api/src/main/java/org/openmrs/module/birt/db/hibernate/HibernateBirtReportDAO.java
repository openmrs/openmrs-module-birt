...
public class HibernateBirtReportDAO implements BirtReportDAO {
	 ...
	 * 
	 * @param id
	 *            the identifier of the desired report
	 * @return the report definition
	 */
	public ReportDefinition getReportDefinition(Integer id) throws DAOException {

		ReportDefinition report;
		report = (ReportDefinition) sessionFactory.getCurrentSession().get(ReportDefinition.class, id);
	...
	public List<ReportDefinition> getReportDefinitions() throws DAOException {
		return sessionFactory.getCurrentSession().createQuery("from ReportDefinition order by name").list();
	}

	/**
	 * Updates the given report definition.
	 */
	public void updateReportDefinition(ReportDefinition reportDef) throws DAOException {

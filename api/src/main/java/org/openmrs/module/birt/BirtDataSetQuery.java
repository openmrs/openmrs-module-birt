...
public class BirtDataSetQuery {
	...
	public String getQueryText() {
		StringBuffer queryText = new StringBuffer().append(BirtConstants.QUERY_BEGIN_DELIMITER)
				.append(BirtConstants.WHITESPACE).append(columns).append(BirtConstants.WHITESPACE)
				.append(BirtConstants.TABLE_BEGIN_DELIMITER).append(BirtConstants.WHITESPACE).append(table);

		if (columnsInfo != null) {
			queryText.append(BirtConstants.WHITESPACE).append(BirtConstants.QUERY_TEXT_DELIMITER)
					.append(BirtConstants.WHITESPACE).append(BirtConstants.COLUMNSINFO_BEGIN_DELIMITER)
					.append(columnsInfo).append(BirtConstants.COLUMNSINFO_END_DELIMITER);
		}

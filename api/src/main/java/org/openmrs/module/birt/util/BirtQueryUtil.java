package org.openmrs.module.birt.util;
...
public class BirtQueryUtil {
	...
	public static String getColumns(String queryText) {
		...
		int startIndex = queryText.toUpperCase().indexOf(BirtConstants.QUERY_BEGIN_DELIMITER)
				+ BirtConstants.QUERY_BEGIN_DELIMITER.length();

		int endIndex = queryText.toUpperCase().lastIndexOf(BirtConstants.TABLE_BEGIN_DELIMITER);
	...
	public static String getTable(String queryText) {
		...
		int startIndex = queryText.toUpperCase().lastIndexOf(BirtConstants.TABLE_BEGIN_DELIMITER)
				+ BirtConstants.TABLE_BEGIN_DELIMITER.length();
	 ...
	 * 
	 * @param queryText
	 * @return an array of strings that represent the query text and columns
	 *         info
	 */
